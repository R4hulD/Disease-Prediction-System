...
w2 = Label(root, justify=CENTER, text="Disease Predictor using Machine Learning", fg="Red", bg="Ivory")
w2.config(font=("Times",30,"bold italic"))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="An apple a day keeps the doctor away", fg="Black", bg="Ivory")
w2.config(font=("Times",30,"bold italic"))
